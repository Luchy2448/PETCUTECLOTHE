        ...
        <div class="row">
            @foreach ($productos as $producto)
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="{{ $producto->image_url ?? 'https://picsum.photos/seed/petcute' . $producto->id . '/400/200.jpg' }}"
                            alt="{{ $producto->name }}" class="card-img-top" style="height: 200px; object-fit: cover;"
                            onerror="this.src='https://picsum.photos/seed/petcute{{ $producto->id }}/400/200.jpg';">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                @if ($producto->category)
                                    <span
                                        class="badge {{ $producto->category->name == 'Casual' ? 'badge-casual' : ($producto->category->name == 'Elegante' ? 'badge-elegante' : 'badge-cumpleanos') }}">
                            ...
                            <a href="{{ route('products.show', $producto->id) }}"
                                class="btn btn-outline-primary w-100 mt-2">Ver Detalles</a>
                        </div>
                    </div>
                </div>
            @endforeach
